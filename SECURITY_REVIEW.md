...
The v0.9.0 browser player is not a generic proxy and does not accept arbitrary URLs. It only accepts a validated station ID, resolves that station through the Safe SomaFM client, and returns a direct SomaFM stream URL.
...
## v0.9.0 stability and repository hygiene note
...
`Auto (recommended)` preserves the stable v0.9.0 behavior by preferring the browser-friendly MP3 128 kbps playlist when available.


## v0.9.0 station metadata note
...
## v0.9.0 sidebar and compact dashboard note
...
## v0.9.0 compact UI and README note
...
## v0.9.0 station index visibility note
...
## v0.9.0 GitHub Pages index note

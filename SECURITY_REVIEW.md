...
The v0.9.1 browser player is not a generic proxy and does not accept arbitrary URLs. It only accepts a validated station ID, resolves that station through the Safe SomaFM client, and returns a direct SomaFM stream URL.
...
## v0.9.1 stability and repository hygiene note
...
`Auto (recommended)` preserves the stable v0.9.1 behavior by preferring the browser-friendly MP3 128 kbps playlist when available.


## v0.9.1 station metadata note
...
## v0.9.1 sidebar and compact dashboard note
...
## v0.9.1 compact UI and README note
...
## v0.9.1 station index visibility note
...
## v0.9.1 GitHub Pages index note
...
## v0.9.1 HACS readiness note

This version adds GitHub Actions for HACS validation and Hassfest validation:
...
No playback logic, network validation, or endpoint behavior was changed.


## v0.9.1 HACS structure note
